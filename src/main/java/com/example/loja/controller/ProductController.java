...
import com.example.loja.service.S3Service;
...
public class ProductController {
    ...
    public ResponseEntity<Object> saveProduct(@ModelAttribute @Valid ProductRecord productRecord) {
        ...
        String urlImg;
        try {
            urlImg = s3Service.uploadFile(productRecord.url_img());
...
//                 s3Service.deleteOldImage(productModel.getUrl_img());
//
//                try {
//                    String newImageUrl = s3Service.fazerUpload(productRecord.url_img());
